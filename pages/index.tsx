  ...
  return (
    ...
    >
      ...
      <h1 className='font-bold text-xl py-6 md:text-2xl lg:text-3xl'>Jobs</h1>
          <p className='font-light text-sm tracking-wide leading-loose md:text-lg lg:text-lg '>Are you passionate about web development and design? Hot Beans, a leading web development company, is seeking talented individuals to join our dynamic team. We&aposre currently hiring for junior and senior web developers, as well as UI/UX designers.

As a junior web developer, you &apos ll have the opportunity to work on exciting projects and learn from experienced developers. We&aposre looking for individuals with a solid foundation in web development and a desire to learn and grow.

For senior web developers, we &apos re seeking individuals with a proven track record of delivering high-quality work, a deep understanding of the latest web development technologies, and a creative problem-solving mindset.

As a UI/UX designer, you &apos ll play a crucial role in creating engaging user experiences. We&apos re looking for individuals with a strong eye for detail, a deep understanding of design principles, and the ability to collaborate effectively with our development team.

Hot Beans offers competitive compensation, a supportive work environment, and opportunities for growth and advancement. If you&aposre ready to take the next step in your career, apply now and join our team of passionate professionals.</p>
          <div className='mt-4'>
      ...
      <img className='rounded ' src='coding.jpg'/>
          <p className='font-light leading-loose tracking-wide text-sm mt-4 md:text-lg lg:text-lg'>At Hot Beans, we believe in empowering individuals and businesses to learn and grow in the ever-evolving world of web development. That&aposs why we&aposve curated a collection of valuable resources to help you master the art of web development.

Our resource page features a range of free and paid resources, including tutorials, articles, videos, and courses, covering various aspects of web development. Whether youre a beginner just starting or an experienced developer looking to upskill, our resources cater to all levels of proficiency.</p>
          <div className='mt-4'>
